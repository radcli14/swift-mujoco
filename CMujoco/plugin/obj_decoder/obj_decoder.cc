...
// We vendor tinyobjloader in header-only mode, so this TU provides its implementation.
...
// Explicit registration entry point; see the note in stl_decoder.cc.
extern "C" void mjregister_obj_decoder(void) {
  mjpDecoder decoder;
