extension MjuiItemMulti {
  ...
  public var name: MjStaticStringArray {
    get { MjStaticStringArray(array: withUnsafeMutablePointer(to: &_itemmulti.pointee.name, { UnsafeMutableRawPointer($0).assumingMemoryBound(to: CChar.self) }), object: object, len: 35, strlen: 40) }
    set {
      let unsafeMutablePointer: UnsafeMutablePointer<CChar> = withUnsafeMutablePointer(to: &_itemmulti.pointee.name, { UnsafeMutableRawPointer($0).assumingMemoryBound(to: CChar.self) })
