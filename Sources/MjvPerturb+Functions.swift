...
extension MjvPerturb {
  ...
  @inlinable
  public mutating func movePerturb(model: MjModel, data: MjData, action: MjtMouse, reldx: Double, reldy: Double, scene: MjvScene) {
    mjv_movePerturb(model._model, data._data, action.rawValue, reldx, reldy, scene._scene, &self._perturb)
  }
  ///  Copy perturb pos,quat from selected body; set scale for perturbation.
  @inlinable
  public mutating func initPerturb(model: MjModel, data: inout MjData, scene: MjvScene) {
